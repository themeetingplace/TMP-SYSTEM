...
// helper 跟 admin 看一樣的 sidebar — 各頁內部的「新增/編輯/刪除」按鈕另外用 CSS/JS 隱藏
// 真正擋住的是: 報表 / 系統設定 / 帳號管理
const HELPER_ALLOWED = new Set(['dashboard', 'properties', 'occupancy', 'contracts', 'finance', 'unsettled', 'maintenance', 'tenants']);
