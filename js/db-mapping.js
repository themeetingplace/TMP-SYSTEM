...
export const toDb = {
    building: b => ({
        ...
        note: b.note ?? null,
        // 代管 + 房屋資料 擴充欄位 (sql/21)
        mode: b.mode ?? 'cohousing',
        owner_id: b.ownerId ?? null,
        layout: b.layout ?? null,
        area_size: b.areaSize != null ? Number(b.areaSize) : null,
        monthly_rent: b.monthlyRent != null ? Number(b.monthlyRent) : null,
        rent_includes_tax: !!b.rentIncludesTax,
        rent_term: b.rentTerm ?? null,
        tax_reported: !!b.taxReported,
        ...
        owner_gender: b.ownerGender ?? '',
        owner_phone: b.ownerPhone ?? '',
        owner_email: b.ownerEmail ?? '',
        owner_line_id: b.ownerLineId ?? ''
    }),
    property: p => ({
        id: p.id,
...
export const fromDb = {
    building: r => ({
        ...
        note: r.note,
        // 代管 + 房屋資料 擴充欄位
        mode: r.mode ?? 'cohousing',
        ownerId: r.owner_id ?? null,
        layout: r.layout ?? null,
        areaSize: r.area_size != null ? Number(r.area_size) : null,
        monthlyRent: r.monthly_rent != null ? Number(r.monthly_rent) : null,
        rentIncludesTax: !!r.rent_includes_tax,
        rentTerm: r.rent_term ?? null,
        taxReported: !!r.tax_reported,
